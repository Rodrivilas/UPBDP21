...
public class Refrigerador implements IElectronicosB{
    private String modelo;
    private int costo;
    private String tiempoDeGarantia;

    public Refrigerador(String modelo, int costo, String tiempoDeGarantia) {
        this.modelo = modelo;
        this.costo = costo;
    ...
    public void tiempoDeGarantia() {
        showInfo();
        System.out.println("El "+modelo+" tiene garantía de: "+ tiempoDeGarantia);
    }
}
