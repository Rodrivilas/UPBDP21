...
public class InstalacionDeAlcantarillado implements IEmpresa{
    ...
    public InstalacionDeAlcantarillado(int numeroTicket, String nombreCliente, String trabajadorDesignado, int precio, IMetodoPago metodoPago) {
